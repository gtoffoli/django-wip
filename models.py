...
class Proxy(models.Model):
    ...
    custom_text = models.TextField(verbose_name='Custom text', blank=True, null=True, help_text="Custom fixed lines of text" )
    head_values = models.TextField(verbose_name='Head values', blank=True, null=True, help_text="Customization of head elements" )
